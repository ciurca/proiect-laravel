    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('participant.register.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="prenume" type="text" class="form-control @error('nume') is-invalid @enderror" name="nume" value="{{ old('nume') }}" required autocomplete="nume" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="telefon" class="col-md-4 col-form-label text-md-end">{{ __('Telefon') }}</label>

                            <div class="col-md-6">
                                <input id="telefon" type="phone" class="form-control @error('telefon') is-invalid @enderror" name="telefon" value="{{ old('telefon') }}" required autocomplete="telefon" autofocus>
